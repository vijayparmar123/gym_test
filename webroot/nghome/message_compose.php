...
function send($id)
{
	...
	//$sql="INSERT INTO `gym_message` (`sender`, `receiver`, `date`, `subject`, `message_body`, `status`) VALUES ($sender,$id,CURRENT_TIMESTAMP,'$subject','$msg_body',1);";
	
	$sql="INSERT INTO `gym_message` (`sender`, `receiver`, `date`, `subject`, `message_body`, `status`) VALUES ($sender,$id,'$date','$subject','$msg_body',1);";
	if ($conn->query($sql)) {
		$result['status']='1';
