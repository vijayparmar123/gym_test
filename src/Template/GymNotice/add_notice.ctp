...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<div class="col-md-6">
			<input type="text" name="start_date" id="startDate" class="form-control validate[required]" value="<?php echo ($edit)?$this->Gym->get_db_format(date($this->Gym->getSettings("date_format"),strtotime($data["start_date"]))): "";?>">
		</div>	
		</div>
