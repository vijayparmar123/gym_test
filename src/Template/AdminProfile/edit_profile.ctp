...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<?php				
			...
			echo '<div class="col-md-6">';
			echo $this->Form->input("",["label"=>false,"name"=>"username","class"=>"form-control validate[required]","value"=>(($edit)?$data['username']:''),'readonly']);
			echo "</div>";	
			echo "</div>";
			...
			echo '<div class="col-md-6">';
			echo $this->Form->password("",["label"=>false,"name"=>"password","class"=>"form-control",'readonly']);
			echo "</div>";	
			echo "</div>";
