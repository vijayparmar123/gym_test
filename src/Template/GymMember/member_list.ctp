		...
		<table class="mydataTable table table-striped" width="100%">
			...
			<?php
				...
				foreach($data as $row)
				{
					...
					{	
						/* ======= demo ===== */
						/* if($row['member_id'] == "M30618")
						{
							echo " <a href='#' title='Edit' class='btn btn-flat btn-primary' disabled='disabled'><i class='fa fa-edit'></i></a>
							<a href='#' title='Delete' class='btn btn-flat btn-danger' disabled='disabled'><i class='fa fa-trash-o'	></i></a>";
						}else{ */
						/* ==== end demo ==== */
...
('#demo').on('click',function(){
	alert("you can not edit or delete this record");
});
</script>